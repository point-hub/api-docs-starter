...
export const description =
  'Learn everything there is to know about the Pointhub API and integrate Protocol into your product.'
...
Use the Pointhub API to access contacts, conversations, group messages, and more and seamlessly integrate your product into the workflows of dozens of devoted Protocol users. {{ className: 'lead' }}

<div className="not-prose mb-16 mt-6 flex gap-3">
  <Button href="/quickstart" arrow="right" children="Quickstart" />
  <Button href="/http-status" arrow="right" variant="outline" children="Http Status" />
</div>
